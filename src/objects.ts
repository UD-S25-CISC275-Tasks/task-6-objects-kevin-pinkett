...
export function isCorrect(question: Question, answer: string): boolean {
    ...
    let ret: boolean;
    question.expected.toLowerCase() === trimmed_answer.toLowerCase() ? ret = true : ret = false;
    return ret;
}
...
export function isValid(question: Question, answer: string): boolean {
    ...
    const found: string | undefined = question.options.find((option: string): boolean => answer === option);
    let ret: boolean;
